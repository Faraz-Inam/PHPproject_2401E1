                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <select name="c_id" class="form-select mb-3" aria-label="Default select example">
                        ...
                        while($option = mysqli_fetch_assoc($cat_q)){ ?>
                            <option value="<?php echo $option['category_id']?>" <?php if($fetch_pr['category_id'] == $option['category_id']){echo "selected = 'selected'";} ?>> <?php echo $option['category_name']?> </option>
                     <?php   }
                        ?>
                    ...
                    <select name="b_id" class="form-select mb-3" aria-label="Default select example">
                        ...
                        while($option = mysqli_fetch_assoc($brand_q)){ ?>
                            <option value="<?php echo $option['brand_id']?>" <?php if($fetch_pr['brand_id'] == $option['brand_id']){echo "selected = 'selected'";} ?>> <?php echo $option['brand_name']?> </option>
                     <?php   }
                        ?>
